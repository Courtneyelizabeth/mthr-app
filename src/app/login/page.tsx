  ...
  return (
    <div className="min-h-screen bg-[#F5F2EE] flex">
      <div className="hidden md:flex w-1/2 relative items-end p-12 overflow-hidden">
        ...
        <img src="https://zhqzwfgqpgnhghkvwcwt.supabase.co/storage/v1/object/public/magazine/MTHRMAGCOVER.jpg" alt="MTHR" className="absolute inset-0 w-full h-full object-cover" />
